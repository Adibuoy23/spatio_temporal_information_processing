...
display_text.setText("Please press l if the 1st stimulus lasted for longer duration, \n s if the 2nd stimulus lasted for shorter duration")
        ...
        for key in event.getKeys():  # check if pressed abort-type key
            ...
            if key in ['s', 'l', 'escape']:
                ...
                if dur <= Durations and key in ['s']:
                    response.append({'Correct':1, 'oddBallDur':dur, 'standardStimDur':Durations, 'keyPress': key, 'Stimulus Onset': oddBallType[ix], 'Initial Direction': initial_dir})
                elif dur > Durations and key in ['l']:
                    response.append({'Correct':1, 'oddBallDur':dur, 'standardStimDur':Durations, 'keyPress': key, 'Stimulus Onset': oddBallType[ix], 'Initial Direction': initial_dir})
                else:
                    response.append({'Correct':0, 'oddBallDur':dur, 'standardStimDur':Durations, 'keyPress': key, 'Stimulus Onset': oddBallType[ix], 'Initial Direction': initial_dir})
