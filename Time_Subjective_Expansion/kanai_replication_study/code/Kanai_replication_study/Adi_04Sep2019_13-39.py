...
conditions = np.array([np.tile([427, 480, 533, 587, 640, 693],10), np.repeat([0,1],30)])
...
dotPatch =  visual.DotStim(myWin, color=(1.0, 1.0, 1.0), dir=0,
