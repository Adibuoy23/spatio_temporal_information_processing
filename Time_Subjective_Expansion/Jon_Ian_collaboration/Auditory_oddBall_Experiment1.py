...
INS_MSG += "The task is simple. In each trial, you will hear an auditory tone appear three times in each trial. We want you to pay attention to how long the tone lasts. Get a sense of its duration.\n\n"
INS_MSG += "After the third time the tone plays out, it will be your turn to report its duration. Press and hold down the spacebar. This will make another tone play out. Let go of the spacebar when you think this tone has lasted for the same duration as the last one. So the point is we want you to reproduce the duration that you experienced. \n\n"

INS_MSG += "Press any key to continue to the next page. \n\n"

INS_MSG2 = "We really want you to be as accurate as you can. So a game will be played to make it more fun. We want you to hold down the space bar for as long as you heard the tone last, but no longer! The closer you get to the right answer, the more points we will award you in that trial. But if you go over, your tone will end on its own and you won't get any points on that trial. So you need to be as accurate as possible without going over to earn the max. Each trial will be for 10 points. There are about 120 trials. If you collect a total of 650 points by the end, we will double the credit you get for the experiment.\n\n"
...
practiceDurations = [750,975,1250]
practiceType = [0,1,2]
