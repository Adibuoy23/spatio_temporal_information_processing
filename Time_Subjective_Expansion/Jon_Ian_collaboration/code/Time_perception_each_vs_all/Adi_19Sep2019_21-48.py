...
for ix,dur in enumerate(possibleOddballDurations):
    ...
    display_text.setText("Press SPACE exactly when you think the stimulus is going to disappear")
    myWin.flip()
    ...
    if keys:
        if 'escape' in keys[0][0]:
            ...
            display_text.setAutoDraw(True)
            display_text.setText('You gained '+str(current_points)+' points. Total: '+str(reward_counter))
