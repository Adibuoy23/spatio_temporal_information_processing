...
for dur in possibleOddballDurations:
    ...
    while oddBallClock.getTime() < dur/1000:
        oddBallStim1.setRadius(oddBallMinRadius + (expansionRate1) * oddBallClock.getTime())
        oddBallStim2.setRadius(oddBallMinRadius + (expansionRate2) * oddBallClock.getTime())
        oddBallStim3.setRadius(oddBallMinRadius + (expansionRate3) * oddBallClock.getTime())
        myWin.flip()
