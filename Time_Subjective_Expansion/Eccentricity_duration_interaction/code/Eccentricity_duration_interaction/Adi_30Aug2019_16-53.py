...
conditions = np.array(np.tile([450, 525, 600, 675, 750, 825, 900, 975, 1050, 1125],6), np.repeat([3,6],30), np.repeat([0,1],30))
...
starStim = visual.ShapeStim(win, vertices=star7Vert, fillColor='green', lineWidth=2, lineColor='white')
