...
for i in range(0, 26):
    letterDraw = visual.TextStim(myWin, pos=(5, 0), colorSpace='rgb', color=letterColor,
...
if doStaircase:
    ...
    while nDoneMain < trials.nTotal and expStop == False:
        ...
        #     myWin, text="The correct answer is : "+str(numberToLetter(correctAnswers[0]))+", "+str(numberToLetter(correctAnswers[1]))+" (lag separation : " + str(cue2lag)+") .\nYour responses are "+str(diffIndex1)+", "+str(diffIndex2)+" lags away from the correct answers respectively.")
        # event.waitKeys()
