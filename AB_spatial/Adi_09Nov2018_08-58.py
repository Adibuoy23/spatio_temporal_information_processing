...
if doStaircase:
    ...
    while nDoneMain < trials.nTotal and expStop == False:
        ...
        correctResponseStim = visual.TextStim(
            myWin, text="The correct answer is : "+str(numberToLetter(correctAnswers[0]))+" (lag separation :)" + str(cue2lag)+", "+str(numberToLetter(correctAnswers[1]))+".\nThey are "+str(diffIndex1)+", "+str(diffIndex2)+" lags away from the correct answers respectively.")
        event.waitKeys()
