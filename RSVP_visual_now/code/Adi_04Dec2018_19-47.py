...
def oneFrameOfStim(n, cueSpatialLoc, letterSequence, cueDurFrames, letterDurFrames, ISIframes, cuesPos):
...
def do_RSVP_stim(cue1pos, cueSpatialLoc, cue2lag, trialN):
    ...
    for n in range(trialDurFrames):  # this is the loop for this trial's stimulus!
        worked = oneFrameOfStim(n, cueSpatialLoc, letterSequence, cueDurFrames, letterDurFrames,
