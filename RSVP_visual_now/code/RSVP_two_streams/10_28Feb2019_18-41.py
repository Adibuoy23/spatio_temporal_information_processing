...
def oneFrameOfStim(n, cue, cueSpatialLoc, letterSequence, cueLetterSequence, cueDurFrames, letterDurFrames, ISIframes, cuesPos, lettersDrawObjects, cueDrawObjects,
...
def do_RSVP_stim(cue1pos, cueSpatialLoc, cue2lag, proportnNoise, trialN):
    ...
    for n in range(trialDurFrames):  # this is the loop for this trial's stimulus!
        worked = oneFrameOfStim(n, cue, cueSpatialLoc, letterSequence, cueLetterSequence, cueDurFrames, letterDurFrames, ISIframes, cuesPos, lettersDrawObjects, cueDrawObjects,
