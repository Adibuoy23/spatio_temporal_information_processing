...
INS_MSG += "You will be presented with two discs. One is in the periphery (#2), and the other is in the fovea (#1).\n\n"
INS_MSG += "Your task is to say which disk flashed first.\n\n"
